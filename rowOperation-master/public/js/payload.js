...
var PayloadPanel = (function() {
  ...
  function payloadUpdateSetup() {
    console.log("payloadUpdateSetup in");
    ...
    Api.setResponsePayload = function(newPayload,ifAudioInput) {
      console.log("PayloadPanel:setResponsePayload")
      currentResponsePayloadSetter.call(Api, newPayload,ifAudioInput);
